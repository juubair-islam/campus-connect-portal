...
// Fetch student
$stmt = $pdo->prepare("SELECT uid, name, email, contact_number FROM students WHERE id=?");
...
.btn-cancel { text-decoration:none; padding:8px 14px; border-radius:6px; background:#9b1b14; color:white; font-weight:600; text-align:center; }
